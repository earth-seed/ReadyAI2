    ...
    <div className="space-y-12">
      ...
      <div className="bg-gradient-to-br from-accent2-lightest to-white rounded-2xl p-8 md:p-12 border border-gray-100">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h3 className="font-heading text-3xl font-medium text-primary">{content.trustSection.title}</h3>
        </div>
        <p className="font-sans text-lg text-gray-700 leading-relaxed mb-6" dangerouslySetInnerHTML={{ __html: content.trustSection.content }}>
        </p>
        {content.trustSection.additionalContent && (
          <p className="font-sans text-lg text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: content.trustSection.additionalContent }}>
          </p>
        )}
      </div>
      ...
      <div className="bg-gradient-to-br from-accent2-lightest to-white rounded-2xl p-8 md:p-12 border border-gray-100">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h3 className="font-heading text-3xl font-medium text-primary">{content.transformationSection.title}</h3>
        </div>
        <p className="font-sans text-lg text-gray-700 leading-relaxed mb-6" dangerouslySetInnerHTML={{ __html: content.transformationSection.content }}>
        </p>
        {content.transformationSection.additionalContent && (
          <p className="font-sans text-lg text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: content.transformationSection.additionalContent }}>
          </p>
        )}
      </div>
      ...
      <div className="bg-gradient-to-br from-accent2-lightest to-white rounded-2xl p-8 md:p-12 border border-gray-100">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h3 className="font-heading text-3xl font-medium text-primary">{content.benefitsSection.title}</h3>
        </div>
          ...
          {content.benefitsSection.benefits.map((benefit, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-xl p-6 border border-gray-100 hover:border-accent/30 hover:shadow-md transition-all duration-300">
                ...
                <h4 className="font-sans text-xl font-semibold text-primary mb-2">{benefit.title}</h4>
      ...
      <div className="bg-gradient-to-br from-primary via-primary-light to-primary-dark rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
        ...
        <div className="relative">
          <h3 className="font-heading text-3xl font-medium text-white mb-6">{content.governanceSection.title}</h3>
      ...
      <div className="bg-gradient-to-br from-accent2-lightest to-white rounded-2xl p-8 md:p-12 border border-gray-100">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h3 className="font-heading text-3xl font-medium text-primary">{content.useCasesSection.title}</h3>
        </div>
        <div className="space-y-6">
          {content.useCasesSection.useCases.map((useCase, index) => (
            <div key={index} className="p-6 bg-white rounded-xl border border-gray-100 hover:border-accent/30 hover:shadow-md transition-all duration-300">
              <h4 className="font-sans text-xl font-semibold text-primary mb-2">{useCase.title}</h4>
              <p className="font-sans text-gray-700 leading-relaxed">{useCase.description}</p>
            </div>
          ))}
        </div>
      </div>
