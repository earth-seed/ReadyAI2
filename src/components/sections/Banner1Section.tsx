    ...
    <div className="bg-white py-16 md:py-24 px-6 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="font-heading text-primary text-4xl md:text-5xl font-normal mb-4">
            Complete AI Platform
          </h2>
          <p className="font-sans text-primary-light text-lg md:text-xl max-w-3xl mx-auto">
