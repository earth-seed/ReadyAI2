        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="space-y-12">
              ...
              >
                <div className="bg-white rounded-2xl border-2 border-gray-200 p-10 md:p-12 shadow-lg hover:shadow-xl transition-all duration-300">
                  <p className="font-sans text-gray-700 text-lg md:text-xl leading-relaxed mb-8">
                  ...
                  <div className="pt-6 border-t border-gray-200">
                    <p className="font-sans text-gray-900 text-xl md:text-2xl leading-relaxed font-semibold">
              ...
              <motion.div
                ...
                className="relative pl-8 md:pl-12"
              >
                <div className="bg-gradient-to-br from-primary via-primary-light to-primary-dark rounded-2xl p-10 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-accent/10 rounded-full blur-3xl"></div>
                  <div className="relative">
                    <p className="font-sans text-white/90 text-lg md:text-xl leading-relaxed mb-8">
                    ...
                    <div className="pt-6 border-t border-white/20">
                      <p className="font-sans text-white text-xl md:text-2xl leading-relaxed font-semibold">
              ...
              <motion.div
                ...
                className="relative pl-8 md:pl-12"
              >
                <div className="bg-white rounded-2xl border-2 border-gray-200 p-10 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden">
